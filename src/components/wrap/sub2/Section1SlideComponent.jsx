...
export default function Section1SlideComponent({ sub2_slide, n}) {
    ...
    return (
        <div className="sub2_slide-container">
            <div className="sub2_slide-view">
                <ul ref={slideWrap}  className="sub2_slide-wrap">


                {
                     sub2_slide.map((item,idx)=>{
                        return(
                            <li className="sub2_slide" key={idx}><a href="!#" onClick={(e)=>onClickSlideEvent(e, idx,item.src)}><img src={item.src} alt="" /></a></li>
                        )
                    })
