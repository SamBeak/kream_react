...
import ShopHeaderSlideChild10Component from './ShopHeaderSlideChild10Component';


export default function ShopHeaderSlide10Component(){
    ...
    React.useEffect(()=>{
        axios({
            url:'http://localhost:3000/data/shop_all_header_slide.json',
            method:'GET'
        })
        .then((res)=>{
            ...
            <div className="container2">
                <div className="content5">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild10Component slide9={state.slide9}/>
                    </div>
