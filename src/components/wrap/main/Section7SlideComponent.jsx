...
export default function Section7SlideComponent({Style_Picks, n}){
                    ...
                    <div className="slide-container">
                        <div className="slide-view">
                            <ul ref={slideWrap} className="slide-wrap">
                                ...
                                {
                                    Style_Picks.map((item, idx)=>{
                                        return(
                                        <li className="slide" key={idx}>
                                        <div className="col-gap">
                                                <a href="!#">
                                                    <img src={`./images/sec7/${item.main}`} alt="" />
                                                    <span><img src={`./images/sec7/${item.span1}`} alt="" /></span>
                                                    <p>{item.span2}</p>
                                                </a>
                                            </div>
                                        </li>
