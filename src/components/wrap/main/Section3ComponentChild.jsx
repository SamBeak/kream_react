...
export default function Section3ComponentChild({Just_Dropped,rows}){
                    ...
                    Just_Dropped.map((item,idx)=>{
                        ...
                        return(
                            <div className="img_txt-box" key={idx}>
                                <a href="!#"><img src={`./images/sec3/${item.image}`} alt="" />
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div className="tag-box">
                                            <img src={`./images/sec3/${item.benefit1}`} alt="" />
