...
export default function BagsFilter2Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("백팩")
            || item.caption.includes("backpack")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/bags/backpack' className='filter-group__rapid-btn on'>백팩</Link>
                    </label>
                    <label>
