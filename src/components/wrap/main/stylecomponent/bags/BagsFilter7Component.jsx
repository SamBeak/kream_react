...
export default function BagsFilter7Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("코스")
            || item.caption.includes("cos")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/bags/cos' className='filter-group__rapid-btn on'>코스</Link>
                    </label>
                  </div>
              </div>
