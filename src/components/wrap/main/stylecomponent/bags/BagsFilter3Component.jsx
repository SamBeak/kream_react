...
export default function BagsFilter3Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("셀린느")
            || item.caption.includes("celine")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/bags/celine' className='filter-group__rapid-btn on'>셀린느</Link>
                    </label>
                    <label>
