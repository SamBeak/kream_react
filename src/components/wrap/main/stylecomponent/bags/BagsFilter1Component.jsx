...
export default function BagsFilter1Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("미니백")
            || item.caption.includes("mini")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/bags/minibag' className='filter-group__rapid-btn on'>미니백</Link>
                    </label>
                    <label>
