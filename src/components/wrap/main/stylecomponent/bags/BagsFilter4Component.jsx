...
export default function BagsFilter4Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("크로스백")
            || item.caption.includes("cross")
            || item.caption.includes("crossbag")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/bags/crossbag' className='filter-group__rapid-btn on'>크로스백</Link>
                    </label>
                    <label>
                    ...
                    <label>
                        ...
                        <Link to='/style/bags/ecobag' className='filter-group__rapid-btn'>에코백</Link>
                    </label>
                    <label>
