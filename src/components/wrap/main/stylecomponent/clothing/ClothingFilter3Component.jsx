...
export default function ClothingFilter3Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("스투시")
            || item.caption.includes("stussy")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/clothing/stussy' className='filter-group__rapid-btn on'>스투시</Link>
                    </label>
                    <label>
