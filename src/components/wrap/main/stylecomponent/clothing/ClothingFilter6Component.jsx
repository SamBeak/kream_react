...
export default function ClothingFilter6Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("우영미")
            || item.caption.includes("wooyoungmi")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/clothing/wooyoungmi' className='filter-group__rapid-btn on'>우영미</Link>
                    </label>
                  </div>
              </div>
