...
export default function ClothingFilter1Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("스트릿")
            || item.caption.includes("street")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/clothing/street' className='filter-group__rapid-btn on'>스트릿</Link>
                    </label>
                    <label>
