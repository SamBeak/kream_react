...
export default function ClothingFilter4Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("아더 에러")
            || item.caption.includes("아더에러")
            || item.caption.includes("adererror")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/clothing/adererror' className='filter-group__rapid-btn on'>아더 에러</Link>
                    </label>
                    <label>
