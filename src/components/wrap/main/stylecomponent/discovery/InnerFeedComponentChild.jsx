                    ...
                    <div className="feeds" key={idx}>
                        ...
                        <div className="social-feed__container">
                            <div className="social-feed__box">
                                ...
                                <button className="prev-slide__btn" onClick={(e)=>prevSlide(e, idx)}><img src="http://localhost:3000/images/innerFeed/arr-left-circle.4d4550b.svg" alt="" />이전</button>
                                <button className="next-slide__btn" onClick={(e)=>nextSlide(e, idx)}><img src="http://localhost:3000/images/innerFeed/arr-right-circle.e115a60.svg" alt="" />다음</button>
