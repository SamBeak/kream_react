      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            ...
            || item.caption.includes("new balance")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                            <div className="filter-group__filter">
                                <label>
                                    ...
                                    <Link to='/stlye/sneakers' className='filter-group__rapid-btn'>전체</Link>
                                </label>
                                <label>
                                ...
                                <label>
                                    ...
                                    <Link to='/style/sneakers/adidas' className='filter-group__rapid-btn'>아디다스</Link>
                                </label>
                                <label>
                                ...
                                <label>
                                    ...
                                    <Link to='/style/sneakers/newb' className='filter-group__rapid-btn on'>뉴발란스</Link>
                                </label>
                                <label>
