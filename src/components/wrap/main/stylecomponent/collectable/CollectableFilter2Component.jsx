...
export default function CollectableFilter2Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("아트토이")
            || item.caption.includes("art toy")
            || item.caption.includes("arttoy")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/collectable/arttoy' className='filter-group__rapid-btn on'>아트토이</Link>
                    </label>
                    <label>
                    ...
                    <label>
                        ...
                        <Link to='/style/collectable/fragrance' className='filter-group__rapid-btn'>향수</Link>
                    </label>
                  </div>
              </div>
