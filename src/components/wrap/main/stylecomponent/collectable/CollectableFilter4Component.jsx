...
export default function CollectableFilter4Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("캠핑")
            || item.caption.includes("camping")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/collectable/camping' className='filter-group__rapid-btn on'>캠핑</Link>
                    </label>
                    <label>
