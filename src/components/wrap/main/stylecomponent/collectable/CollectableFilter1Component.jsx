...
export default function CollectableFilter1Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("레고")
            || item.caption.includes("lego")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/collectable/lego' className='filter-group__rapid-btn on'>레고</Link>
                    </label>
                    <label>
