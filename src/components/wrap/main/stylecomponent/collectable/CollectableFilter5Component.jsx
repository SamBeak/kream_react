...
export default function CollectableFilter5Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("슈프림")
            || item.caption.includes("supreme")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/collectable/supreme' className='filter-group__rapid-btn on'>슈프림</Link>
                    </label>
                    <label>
