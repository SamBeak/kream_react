...
export default function CollectableFilter3Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("인테리어")
            || item.caption.includes("interier")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/collectable/interier' className='filter-group__rapid-btn on'>인테리어</Link>
                    </label>
                    <label>
