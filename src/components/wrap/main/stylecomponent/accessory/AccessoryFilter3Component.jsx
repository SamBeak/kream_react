...
export default function AccessoryFilter3Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("폰케이스")
            || item.caption.includes("phone case")
            || item.caption.includes("phonecase")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/accessory/phonecase' className='filter-group__rapid-btn on'>폰케이스</Link>
                    </label>
                    <label>
