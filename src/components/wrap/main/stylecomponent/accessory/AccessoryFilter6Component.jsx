...
export default function AccessoryFilter6Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("스카프")
            || item.caption.includes("scarf")
            || item.caption.includes("muffler")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/accessory/scarf' className='filter-group__rapid-btn on'>스카프</Link>
                    </label>
                    <label>
