...
export default function AccessoryFilter1Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            ...
            || item.caption.includes("cap")
            || item.caption.includes("hat")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/accessory/cap' className='filter-group__rapid-btn on'>모자</Link>
                    </label>
                    <label>
