...
export default function StyleMainComponent() {
    ...
    const [state, setState] = React.useState({
      ...
      React.useEffect(()=>{
          axios({
              url: 'http://localhost:3000/data/style_page/found.json',
              method: 'GET'
          })
          .then((res)=>{
              if(res.status===200){
                ...
                <div className="content">
                    ...
                    <div className="tag-container">
                            ...
                            <div className="tag-box">
                                <img src="http://localhost:3000/images/tagImg/tagImg1.jpg" alt="" />
                                <p>#스타일랭킹</p>
                            </div>
                            </Link>
                            <Link to="./tag2">
                            <div className="tag-box">
                                <img src="http://localhost:3000/images/tagImg/tagImg2.jpg" alt="" />
                                <p>#FocusOnMe</p>
                            </div>
                            </Link>
                            <Link to="./tag3">
                            <div className="tag-box">
                                <img src="http://localhost:3000/images/tagImg/tagImg3.jpg" alt="" />
                                <p>#오늘의신발</p>
                            </div>
                            </Link>
                            <Link to="./tag4">
                            <div className="tag-box">
                                <img src="http://localhost:3000/images/tagImg/tagImg4.jpg" alt="" />
                                <p>#OOTD</p>
                            </div>
                            </Link>
                            <Link to="./tag5">
                            <div className="tag-box">
                                <img src="http://localhost:3000/images/tagImg/tagImg5.jpg" alt="" />
                                <p>#줌인리뷰</p>
                            </div>
                            </Link>
                            <Link to="./tag6">
                            <div className="tag-box">
                                <img src="http://localhost:3000/images/tagImg/tagImg6.jpg" alt="" />
                                <p>#조던</p>
                            </div>
                            </Link>
                            <Link to="./tag7">
                            <div className="tag-box">
                                <img src="http://localhost:3000/images/tagImg/tagImg7.jpg" alt="" />
                                <p>#스투시</p>
                            </div>
                            </Link>
                            <Link to="./tag8">
                            <div className="tag-box">
                                <img src="http://localhost:3000/images/tagImg/tagImg8.jpg" alt="" />
                                <p>#스타일</p>
                            </div>
                            </Link>
                            <Link to="./tag9">
                            <div className="tag-box">
                                <img src="http://localhost:3000/images/tagImg/tagImg9.jpg" alt="" />
                                <p>#챌린지</p>
                            </div>
                            </Link>
                    </div>
