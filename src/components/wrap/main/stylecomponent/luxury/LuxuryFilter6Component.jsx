...
export default function SneakersFilter6Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("미우미우")
            || item.caption.includes("miumiu")
          );
          setState({
            ...state,
            post: filteredData
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/luxury/miumiu' className='filter-group__rapid-btn on'>미우미우</Link>
                    </label>
                    <label>
