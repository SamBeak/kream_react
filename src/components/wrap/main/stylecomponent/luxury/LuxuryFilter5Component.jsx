...
export default function SneakersFilter5Component() {
      ...
      .then((res) => {
        if (res.status === 200) {
          const filteredData = res.data.post.filter((item) =>
            item.caption.includes("prada")
            || item.caption.includes("프라다")
          );
          setState({
            ...state,
              ...
              <div className="filter-group__container">
                  <div className="filter-group__filter">
                    ...
                    <label>
                        ...
                        <Link to='/style/luxury/prada' className='filter-group__rapid-btn on'>프라다</Link>
                    </label>
                    <label>
