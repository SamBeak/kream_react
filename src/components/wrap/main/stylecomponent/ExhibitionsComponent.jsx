            ...
            <div className="gap">
                <div className="exhibition__bg">
                    <figure className="img__container">
                        ...
                        <img src="http://localhost:3000/images/a_94f6963e4a8642e49f0b3f861f9fc939.jpg" alt="데일리 위클리 미션" />
                    </figure>
                </div>
                <div className="exhibition__img">
                    <figure className="img__container">
                        <div className="img__link"></div>
                        <img src="http://localhost:3000/images/a_998c800d6e874ed187f11073f0134f08.jpg" alt="" />
                    </figure>
                </div>
                <div className="exhibition__img">
                    <figure className="img__container">
                        <div className="img__link"></div>
                        <img src="http://localhost:3000/images/a_99fa44d09a804483b1d77ebee71474b1.jpg" alt="" />
                    </figure>
                </div>
                <div className="exhibition__img">
                    <figure className="img__container">
                        <div className="img__link"></div>
                        <img src="http://localhost:3000/images/a_19ea872b814f445494d873a2e2e0a936.jpg" alt="" />
