...
export default function Section1SlideComponent({slide, n}) {
    ...
    return (
        <div className="main_slide-container">
            <div className="main_slide-view">
                <ul ref={slideWrap}  className="main_slide-wrap">


                {
                    slide.map((item,idx)=>{
                        return(
                            <li className="main_slide" key={idx}><a href="!#" onClick={(e)=>onClickSlideEvent(e, idx,item.src)}><img src={item.src} alt="" /></a></li>
                        )
                    })
