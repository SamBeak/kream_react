...
import ShopMainContentChild9Component from './ShopMainContentChild9Component';
import ShopMainContentNavComponent from './ShopMainContentNavComponent';



export default function ShopMainContent9Component(){
    ...
    const getProductAPI=()=>{
        axios({
            url:'http://localhost:3000/data/watch_product.json',
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                                ...
                                <div className="left-box box1">
                                    ...
                                    <div className="sub">
                                        <ul>
                                            <li>
                                                <label>
                                                    <input type="checkbox" nayme='' id='' value={"프리미엄시계"} />
                                                    &nbsp;프리미엄시계
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"전자 시계"} />
                                                    &nbsp;전자 시계
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"가죽 시계"} />
                                                    &nbsp;가죽 시계
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"메탈 시계"} />
                                                    &nbsp;메탈 시계
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"기타 시계"} />
                                                    &nbsp;기타 시계
                                                </label>
                                            </li>
                                        </ul>
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild9Component watch={watch.watch}/>
                    </div>
                </div>
            </div>
        </div>
