...
import ShopHeaderSlideChild9Component from './ShopHeaderSlideChild9Component';
import './scss/shop_main_header_slide_9.scss';

export default function ShopHeaderSlide9Component(){
            ...
            <div className="container2">
                <div className="content-small">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild9Component slide8={state.slide8}/>
                    </div>
                </div>
