...
import ShopMainContentChild12Component from './ShopMainContentChild12Component';
import ShopMainContentNavComponent from './ShopMainContentNavComponent';



export default function ShopMainContent12Component(){
    ...
    const getProductAPI=()=>{
        axios({
            url:'http://localhost:3000/data/beauty_product.json',
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild12Component beauty={beauty.beauty}/>
                    </div>
                </div>
            </div>
        </div>
