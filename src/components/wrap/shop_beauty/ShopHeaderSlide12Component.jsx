...
import ShopHeaderSlideChild12Component from './ShopHeaderSlideChild12Component';
import './scss/shop_main_header_slide_9.scss';

export default function ShopHeaderSlide12Component(){
            ...
            <div className="container2">
                <div className="content-small">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild12Component slide11={state.slide11}/>
                    </div>
                </div>
