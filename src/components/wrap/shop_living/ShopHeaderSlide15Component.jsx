...
import ShopHeaderSlideChild15Component from './ShopHeaderSlideChild15Component';
import './scss/shop_main_header_slide_9.scss';

export default function ShopHeaderSlide15Component(){
            ...
            <div className="container">
                <div className="content-small">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild15Component slide14={state.slide14}/>
                    </div> 
                </div>
