                                ...
                                <div className="slide-view-d">
                                    <ul className="slide-wrap-d">
                                        <li className="slide-d slide1">
                                            <a href="!#">
                                                <img src={`http://localhost:3000/images/shop_main_all/${product1.slide1}`} alt="" />
                                            </a>
                                        </li>
                                        <li className="slide-d slide2">
                                            <a href="!#">
                                                <img src={`http://localhost:3000/images/shop_main_all/${product1.slide2}`} alt="" />
                                            </a>
                                        </li>
                                        <li className="slide-d slide3">
                                            <a href="!#">
                                                <img src={`http://localhost:3000/images/shop_main_all/${product1.slide3}`} alt="" />
                                            </a>
                                        </li>
                                        <li className="slide-d slide4">
                                            <a href="!#">
                                                <img src={`http://localhost:3000/images/shop_main_all/${product1.slide4}`} alt="" />
                                            </a>
                                        </li>
