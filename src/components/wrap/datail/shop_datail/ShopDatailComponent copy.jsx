...
export default function ShopDatailComponent({product}){
    ...
    React.useEffect(()=>{
        ...
        //     }
        //     if(cnt<0){
        //         $slideWrap.stop().animate({left:`${-100 * 0}%`})
                                ...
                                <div className="slide-view">
                                    <ul className="slide-wrap">
                                        <li className="slide slide1">
                                            <a href="!#">
                                                <img src="./images/detail/a_baa1ccea3726495badba419dfede63f9.png" alt="" />
                                            </a>
                                        </li>
                                        <li className="slide slide2">
                                            <a href="!#">
                                                <img src="./images/detail/a_25272afc5f6f4ff4bc6f474ebae0406c.png" alt="" />
                                            </a>
                                        </li>
                                        <li className="slide slide3">
                                            <a href="!#">
                                                <img src="./images/detail/a_5860ca7dd5a64b78ab3d2a2f395f2403.png" alt="" />
                                            </a>
                                        </li>
                                        <li className="slide slide4">
                                            <a href="!#">
                                                <img src="./images/detail/a_718ba68027f749b79313691f17a2e394.png" alt="" />
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div className="content-box">
                            <div className="content-top-box">
                                <div className="main-title-box">
                                    ...
                                    <p className='title-detail'> Nike Air Force 1 '07 Low White </p>
                                    <p className='sub-detail'> 나이키 에어포스 1 '07 로우 화이트 </p>
                                </div>
                                <div className="datail-price">
                                    ...
                                    <div className="price-amount">
                                        <span className='num'>118,000</span>
                                    ...
                                    <div className="btn1-box">
                                        <div className="input">
                                            <form name='' id='' method='POST' action="">
                                                <input type="text" name='' id='' placeholder='구매 가격을 입력하시오' />   
