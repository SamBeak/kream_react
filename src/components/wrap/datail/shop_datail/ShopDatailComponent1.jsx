...
export default function ShopDatailComponent({product,allProduct,isTopHeader,headerDisable,local}){
    ...
    //     console.log(ids);
    //     // 주어진 JSON 데이터의 id 값
    //     const jsonId = allProduct.id; // 예시로 "1"을 사용했습니다. 실제 데이터에 맞게 수정해주세요.

    //     // 배열에서 id 값과 주어진 JSON 데이터의 id 값 비교
    //     const matchingItem = ids.find(item => item.id === jsonId);
    ...
    // }, [])
        ...
        // 찾고자 하는 아이템의 id 값
        const itemId = viewData.id; // 예시로 "1"을 사용했습니다. 실제 데이터에 맞게 수정해주세요.
      
        // 아이템 찾기
        const foundItem = localStorage.getItem(recentlyViewedItems, itemId);
        // console.log(itemId);
                                    ...
                                    <div className="slide-view-d">
                                        <ul className="slide-wrap-d">
                                            <li className="slide-d slide1">
                                                <a href="!#">
                                                    <img src={`http://localhost:3000/images/shop_main_all/${viewed1.slide1}`} alt="" />
                                                </a>
                                            </li>
                                            <li className="slide-d slide2">
                                                <a href="!#">
                                                    <img src={`http://localhost:3000/images/shop_main_all/${viewed1.slide2}`} alt="" />
                                                </a>
                                            </li>
                                            <li className="slide-d slide3">
                                                <a href="!#">
                                                    <img src={`http://localhost:3000/images/shop_main_all/${viewed1.slide3}`} alt="" />
                                                </a>
                                            </li>
                                            <li className="slide-d slide4">
                                                <a href="!#">
                                                    <img src={`http://localhost:3000/images/shop_main_all/${viewed1.slide4}`} alt="" />
                                                </a>
                                            </li>

                                        </ul>
                                        <a href="!#" className='arrow-btn-next1'><img src="http://localhost:3000/images/detail/grey_arrow.svg" alt="" /></a>
                                        <a href="!#" className='arrow-btn-prev1'><img src="http://localhost:3000/images/detail/grey_arrow2.svg" alt="" /></a>
                                    </div>
                                </div>
                            </div>
                            <div className="content-box">
                                <div className="content-top-box">
                                    <div className="main-title-box">
                                        <div className="title">
                                            <a href="!#">{viewed1.brand}</a>
                                        </div>
                                        <p className='title-detail'> {viewed1.descE} </p>
                                        <p className='sub-detail'> {viewed1.descK} </p>
                                    </div>
                                    <div className="datail-price">
                                        ...
                                        <div className="price-amount">
                                            <span className='num'>{viewed1.price}</span>
                                    ...
                                    <div className="btn-wrap">
                                        ...
                                        <div className="btn2-box">
                                            <a href="!#">
                                                <span className='img-span'><img src="http://localhost:3000/images/detail/20230524_133944.png" alt="" /></span>
                                ...
                                <div className="content-product-box">
                                    ...
                                    <div className="delivery-datail">
                                        ...
                                        <div className="deliver-way">
                                            <div className="img">
                                                <img src="http://localhost:3000/images/detail/a_120a84f036724d0d97a2343aafff4ecf.png" alt="" />
                                            </div>
                                            <div className="content1">
                                                <span className='s1'>빠른배송 </span>
                                                <span className='s2'>5,000원</span>
                                                <span className='s3'><img src="http://localhost:3000/images/detail/help_gray.svg" alt="" /></span>
                                        ...
                                        <div className="deliver-way">
                                            <div className="img">
                                                <img src="http://localhost:3000/images/detail/a_8b54cbca40e945f4abf1ee24bdd031f7.png" alt="" />
                                            </div>
                                            <div className="content1">
                                        ...
                                        <div className="deliver-way">
                                            <div className="img">
                                                <img src="http://localhost:3000/images/detail/a_f82951f1984b404db30b9c4fca4bd695.png" alt="" />
                                            </div>
                                            <div className="content1">
                                    ...
                                    <div className="banner">
                                        <a href="!#"><img src="http://localhost:3000/images/detail/banner.jpg" alt="" /></a>
                                    </div>
                                    <div className="graph">
                                        ...
                                        <div className="table">
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td> 115,000원 <i><img src="http://localhost:3000/images/detail/iconGreen.svg" alt="" /></i></td>
                                                        <td>4</td>
                                                    </tr>
                                                    <tr>
                                                        <td> 115,000원 <i><img src="http://localhost:3000/images/detail/iconGreen.svg" alt="" /></i></td>
                                    ...
                                    <div className="ex">
                                        <div className="wrap-wrap">
                                            <div className="image">
                                                <img src="http://localhost:3000/images/detail/img-guide-item-01.fa306b8.svg" alt="" />
                                            </div>
                                            <div class="text_area">
                                        ...
                                        <div className="wrap-wrap">
                                            <div className="image">
                                                <img src="http://localhost:3000/images/detail/다운로드.svg" alt="" />
                                            </div>
                                            <div class="text_area">
                                        ...
                                        <div className="wrap-wrap">
                                            <div className="image">
                                                <img src="http://localhost:3000/images/detail/img-guide-item-03.963fee7.svg" alt="" />
                                            </div>
                                            <div class="text_area">
