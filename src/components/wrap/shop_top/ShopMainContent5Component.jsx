...
import ShopMainContentChild5Component from './ShopMainContentChild5Component';
import ShopMainContentNavComponent from './ShopMainContentNavComponent';



export default function ShopMainContent5Component(){
    ...
    const getProductAPI=()=>{
        axios({
            url:'http://localhost:3000/data/top_product.json',
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                                ...
                                <div className="left-box box1">
                                    ...
                                    <div className="sub">
                                        <ul>
                                            <li>
                                                <label>
                                                    <input type="checkbox" nayme='' id='' value={"반팔 티셔츠"} />
                                                    &nbsp;반팔 티셔츠
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"긴팔 티셔츠"} />
                                                    &nbsp;긴팔 티셔츠
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"가디건"} />
                                                    &nbsp;가디건
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"셔츠"} />
                                                    &nbsp;셔츠
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"후드"} />
                                                    &nbsp;후드
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"후드 집업"} />
                                                    &nbsp;후드 집업
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"스웨트셔츠"} />
                                                    &nbsp;스웨트셔츠
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"슬리브리스"} />
                                                    &nbsp;슬리브리스
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"원피스"} />
                                                    &nbsp;원피스
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"니트"} />
                                                    &nbsp;니트
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"기타 상의"} />
                                                    &nbsp;기타 상의
                                                </label>
                                            </li>
                                        </ul>
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild5Component top={top.top}/>
                    </div>
                </div>
            </div>
        </div>
