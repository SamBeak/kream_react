...
export default function ShopMainContentChildComponent({allProduct,setViewProduct,sorted,sorted1}){
    ...
    const onClickProductList=(e, product)=>{
        ...
        let obj ={
            brand:product.brand,
            img:`http://localhost:3000/images/shop_main_all/${product.slide1} `,
            descE:product.descE,
            descK:product.descK,
            price:product.price,
            wish:product.wish,
                        ...
                        <li className='p-list' key={id}  onClick={(e)=>onClickProductList(e,item)}> 
                            <Link to ={`/shop/main/${item.id}`} className='product-a'  >
                                <div className="img-box" >
                                    <img src={`http://localhost:3000/images/shop_main_all/${item.slide1}`} alt="" />
                                </div>
                                <div className="title-box">
                                    ...
                                    <div className="deliver">
                                        <img src="http://localhost:3000/images/shop_main_all/a_82699e0f38f24003897bcfc6ee5c84eb.png" alt="" />
                                        <span>빠른배송</span>
                                    </div>
                                    ...
                                    <div className="action-wish-review">
                                        <span className='wish-img'><img src="http://localhost:3000/images/shop_main_all/wish-list-grey.svg" alt="" /></span>
                                        <span className='wish-content'>{item.wish}</span>
                                        <span className='review-img' ><img src="http://localhost:3000/images/shop_main_all/review-grey.svg" alt="" /></span>
