...
import ShopMainContentChild4Component from './ShopMainContentChild4Component';
...
export default function ShopMainContent2Component(){
    ...
    const getProductAPI=()=>{
        axios({
            url:'http://localhost:3000/data/outer_product.json',
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                                ...
                                <div className="left-box box1">
                                    ...
                                    <div className="sub">
                                        <ul>
                                            <li>
                                                <label>
                                                    <input type="checkbox" nayme='' id='' value={"자켓"} />
                                                    &nbsp;자켓
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"아노락"} />
                                                    &nbsp;아노락
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"코트"} />
                                                    &nbsp;코트
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"패딩"} />
                                                    &nbsp;패딩
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"기타 아우터"} />
                                                    &nbsp;기타 아우터
                                                </label>
                                            </li>
                                        </ul>
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild4Component outer={outer.outer}/>
                    </div>
                </div>
            </div>
        </div>
