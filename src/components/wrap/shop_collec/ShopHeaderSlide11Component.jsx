...
import ShopHeaderSlideChild11Component from './ShopHeaderSlideChild11Component';
import'./scss/shop_main_header_slide_9.scss';

export default function ShopHeaderSlide11Component(){
            ...
            <div className="container2">
                <div className="content-small">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild11Component slide10={state.slide10}/>
                    </div>
                </div>
