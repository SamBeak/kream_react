...
import ShopMainContentChild3Component from './ShopMainContentChild3Component';
...
export default function ShopMainContent2Component(){
    ...
    const getProductAPI=()=>{
        axios({
            url:'http://localhost:3000/data/shoes_product.json',
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                                ...
                                <div className="left-box box1">
                                    ...
                                    <div className="sub">
                                        <ul>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"스니커즈"} />
                                                    &nbsp;스니커즈  
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"샌들/슬리퍼"} />
                                                    &nbsp;샌들/슬리퍼
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"플랫"} />
                                                    &nbsp;플랫
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"로퍼"} />
                                                    &nbsp;로퍼
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"더비/레이스업"} />
                                                    &nbsp;더비/레이스업
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"힐/펌프스"} />
                                                    &nbsp;힐/펌프스
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"부츠"} />
                                                    &nbsp;부츠
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"기타 신발"} />
                                                    &nbsp;기타 신발
                                                </label>
                                            </li>
                                        </ul>
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild3Component shoes={shoes.shoes}/>
                    </div>
                </div>
            </div>
        </div>
