        ...
        <div id='wrap'>
            <div className="container">
                ...
                <div className="main-inner">
                    <h1>
                        <a href="!#"><img src="http://localhost:3000/images/shop_main_all/logo.svg" alt="" /></a>
                    </h1>
                    <div className="right-box">
                        <div className="right-content">
                            <ul className="content-wrap">
                                ...
                                <li className="content-list"><a href="!#"><img src="http://localhost:3000/images/shop_main_all/icon-search-black.svg" alt="" /></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
