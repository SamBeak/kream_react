...
import ShopHeaderSlideChild13Component from './ShopHeaderSlideChild13Component';
            ...
            <div className="container2">
                <div className="content5">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild13Component slide12={state.slide12}/>
                    </div>
