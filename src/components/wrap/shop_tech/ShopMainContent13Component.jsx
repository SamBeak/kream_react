...
import ShopMainContentChild13Component from './ShopMainContentChild13Component';
import ShopMainContentNavComponent from './ShopMainContentNavComponent';



export default function ShopMainContent13Component(){
    ...
    const getProductAPI=()=>{
        axios({
            url:'http://localhost:3000/data/tech_product.json',
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild13Component tech={tech.tech}/>
                    </div>
                </div>
            </div>
        </div>
