...
import ShopHeaderSlideChild7Component from './ShopHeaderSlideChild7Component';


export default function ShopHeaderSlide7Component(){
            ...
            <div className="container2">
                <div className="content5">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild7Component slide6={state.slide6}/>
                    </div>
