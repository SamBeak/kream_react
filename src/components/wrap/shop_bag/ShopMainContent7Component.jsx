...
import ShopMainContentChild7Component from './ShopMainContentChild7Component';
import ShopMainContentNavComponent from './ShopMainContentNavComponent';



export default function ShopMainContent7Component(){
    ...
    const getProductAPI=()=>{
        axios({
            url:'http://localhost:3000/data/bag_product.json',
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                                ...
                                <div className="left-box box1">
                                    ...
                                    <div className="sub">
                                        <ul>
                                            <li>
                                                <label>
                                                    <input type="checkbox" nayme='' id='' value={"프리미엄가방"} />
                                                    &nbsp;프리미엄가방
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"미니백"} />
                                                    &nbsp;미니백
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"백팩"} />
                                                    &nbsp;백팩
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"숄더백"} />
                                                    &nbsp;숄더백
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"토트백"} />
                                                    &nbsp;토트백
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"크로스백"} />
                                                    &nbsp;크로스백
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"클러치"} />
                                                    &nbsp;클러치
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"더플백"} />
                                                    &nbsp;더플백
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"에코백"} />
                                                    &nbsp;에코백
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"캐리어"} />
                                                    &nbsp;캐리어
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"기타 가방"} />
                                                    &nbsp;기타 가방
                                                </label>
                                            </li>
                                        </ul>
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild7Component bag={bag.bag}/>
                    </div>
                </div>
            </div>
        </div>
