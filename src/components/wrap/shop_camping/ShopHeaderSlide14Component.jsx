...
import ShopHeaderSlideChild14Component from './ShopHeaderSlideChild14Component';
import './scss/shop_main_header_slide_9.scss';

export default function ShopHeaderSlide14Component(){
            ...
            <div className="container">
                <div className="content-small">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild14Component slide13={state.slide13}/>
                    </div>
                </div>
