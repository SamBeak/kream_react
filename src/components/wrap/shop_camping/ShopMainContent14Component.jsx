...
import ShopMainContentChild14Component from './ShopMainContentChild14Component';
import ShopMainContentNavComponent from './ShopMainContentNavComponent';



export default function ShopMainContent14Component(){
    ...
    const [camping,setCamping] =React.useState({
        camping:[]
    ...
    const getProductAPI=()=>{
        axios({
            url:'http://localhost:3000/data/camping_product.json',
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild14Component camping={camping.camping}/>
                    </div>
                </div>
            </div>
        </div>
