...
import ShopHeaderSlideChild2Component from './ShopHeaderSlideChild2Component';


export default function ShopHeaderSlide2Component(){
    ...
    React.useEffect(()=>{
        axios({
            url:'http://localhost:3000/data//luxury_header_slide.json',  
            method:'GET'
        })
        .then((res)=>{
           console.log(`res.date 확인 ${res.data}`);
            if(res.status===200){
                setState({
                    ...state,
            ...
            <div className="container2">
                <div className="content5">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild2Component slide={state.slide}/>
                    </div>
                    <a href="!#" className='header-slide-arrow-next'><img src="http://localhost:3000/images/shop_main_all/arrow.svg" alt="" /></a>
                    <a href="!#" className='header-slide-arrow-prev'><img src="http://localhost:3000/images/shop_main_all/arrow.svg" alt="" /></a>
