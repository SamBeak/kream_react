...
import ShopMainContentChild2Component from './ShopMainContentChild2Component';
...
export default function ShopMainContent2Component(){
    ...
    const [luxury,setLuxury] =React.useState({
        luxury:[]
    ...
    const getProductAPI=()=>{
        axios({
            url:"http://localhost:3000/data/luxury_product.json",
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild2Component luxury={luxury.luxury}/>
                    </div>
                </div>
            </div>
        </div>
