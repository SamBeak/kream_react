...
export default function Section7SlideComponent({Celeb_Shot, n}){
                    ...
                    <div className="slide-container">
                        <div className="slide-view">
                            <ul ref={slideWrap} className="slide-wrap">
                                ...
                                {
                                    Celeb_Shot.map((item, idx)=>{
                                        return(
                                        <li className="slide" key={idx}>
                                        <div className="col-gap">
                                                <a href="!#">
                                                    <img src={`./images/sub3_sec7/${item.main}`} alt="" />
                                                    <span><img src={`./images/sub3_sec7/${item.span1}`} alt="" /></span>
                                                    <p>{item.span2}</p>
                                                </a>
                                            </div>
                                        </li>
