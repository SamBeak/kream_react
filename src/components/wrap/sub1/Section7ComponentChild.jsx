...
export default  function Section7ComponentChild({best, rows}){
            ...
            best.map((item,idx)=>{
                ...
                return(
                    <div className="img_txt-box" key={idx}>
                        <a href="!#"><img src={`http://localhost:3000/images/sub1_sec7/${item.image}`} alt="" /> 
                        ...
                        <ul>
                            ...
                            <li>
                                <div className="tag-box">
                                    <img src={`http://localhost:3000/images/sub1_sec7/${item.benefit1}`} alt="" />
