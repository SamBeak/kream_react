...
export default function Section1SlideComponent({sub4_slide, n}) {
    ...
    return (
        <div className="sub4_slide-container">
            <div className="sub4_slide-view">
                <ul ref={slideWrap}  className="sub4_slide-wrap">


                {
                    sub4_slide.map((item,idx)=>{
                        return(
                            <li className="sub4_slide" key={idx}><a href="!#" onClick={(e)=>onClickSlideEvent(e, idx,item.src)}><img src={item.src} alt="" /></a></li>
                        )
                    })
