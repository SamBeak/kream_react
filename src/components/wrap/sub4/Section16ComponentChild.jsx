...
export default function Section16ComponentChild({Jackets_for_These_Days,rows}){
    ...
    React.useEffect(()=>{
        Jackets_for_These_Days.map((item, idx)=>{
        });

    },[Jackets_for_These_Days]);
                    ...
                    Jackets_for_These_Days.map((item,idx)=>{
                        ...
                        return(
                            <div className="img_txt-box" key={idx}>
                                <a href="!#"><img src={`./images/sub4_sec16/${item.image}`} alt="" />
