...
import ShopHeaderSlideChild8Component from './ShopHeaderSlideChild8Component';
import'./scss/shop_main_header_slide_9.scss';

export default function ShopHeaderSlide8Component(){
            ...
            <div className="container2">
                <div className="content-small">
                    <div className="title-slide-container">
                        <ShopHeaderSlideChild8Component slide7={state.slide7}/>
                    </div> 
                </div>
