...
import ShopMainContentChild8Component from './ShopMainContentChild8Component';
import ShopMainContentNavComponent from './ShopMainContentNavComponent';



export default function ShopMainContent8Component(){
    ...
    const [purse,setPurse] =React.useState({
        purse:[]
    ...
    const getProductAPI=()=>{
        axios({
            url:'http://localhost:3000/data/purse_product.json',
            method:'GET'
        })
        .then((res)=>{  
                ...
                <div className="content2">
                                ...
                                <div className="left-box box1">
                                    ...
                                    <div className="sub">
                                        <ul>
                                            <li>
                                                <label>
                                                    <input type="checkbox" nayme='' id='' value={"반지갑"} />
                                                    &nbsp;반지갑
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"장지갑"} />
                                                    &nbsp;장지갑
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"카드지갑"} />
                                                    &nbsp;카드지갑
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"체인지갑"} />
                                                    &nbsp;체인지갑
                                                </label>
                                            </li>
                                            <li>
                                                <label>
                                                    <input type="checkbox" name='' id='' value={"기타지갑"} />
                                                    &nbsp;기타지갑
                                                </label>
                                            </li>
                                        </ul>
                    ...
                    <div className="right">
                        ...
                        <div className="filter">
                            ...
                            <ShopMainContentChild8Component purse={purse.purse}/>
                    </div>
                </div>
            </div>
        </div>
